...
#####################
$sqlSelectPrincipal="SELECT * FROM principal_temp WHERE id=".$idprincipal;
...
###
##########
$sql_UpdatePrincipal="UPDATE principal_temp SET 
nombre_comercial_establecimiento='$NOMBRE_COMERCIAL_ESTABLECIMIENTO', 
...
if ($query_UpdatePrincipal) {
				...
				$messages[] = "El Registro se ha Actualizado con Exito Folio ($folioDB)";
			} else {
