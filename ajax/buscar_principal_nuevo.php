                        ...
                        <td data-label="Acciones" class="acciones-celda">
                            <div class="action-buttons">
                                ...
                                if ($estatus == "Presupuesto") {
                                    $mostrarBotonAmarillo = true;
                                    $botonAmarilloHTML .= '<button type="button" class="btn amarillo-bottom" style="background-color:#ffc107 !important; color:white !important;" title="Presupuesto" onclick="presupuesto(\''.$id.'\')"><i class="bi bi-receipt"></i> Presupuesto</button>';
                                }
