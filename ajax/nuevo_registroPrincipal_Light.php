...
$Kuery_Update="UPDATE principal SET folio='$folio', id_servicios_adicionales_permisionario=".$ID_SERVICIOS_ADICIONALES_PERMISIONARIO.", id_tramite=$ID_TRAMITE , id_proceso_tramites=$ID_PROCESO_TRAMITE  WHERE id=".$ID;
