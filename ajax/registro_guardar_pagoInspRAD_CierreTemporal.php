...
###########
$Kuery_Update_principal="UPDATE principal SET estatus='Pago INSP-CierreTemporal' WHERE id=".$ID;
break;
    case "Inspeccion":
##
##
...
##
$Kuery_Update_principal="UPDATE principal SET estatus='Pago RAD-CierreTemporal' WHERE id=".$ID;
break;
    default:
$Kuery_Update_principal="UPDATE principal SET estatus='PAGO X-CierreTemporal' WHERE id=".$ID;
}
...
$Kuery_Update2_principal="UPDATE principal SET estatus='Pago IRAD-CierreTemporal' WHERE id=".$ID;
...
$Kuery_Update3_INS="UPDATE inspeccion SET fecha_inicio='$today', en_proceso='En Proceso' WHERE id_principal=".$ID." AND id_proceso_tramites=".$ID_PROCESO_TRAMITE;
