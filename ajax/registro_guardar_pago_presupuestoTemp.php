...
$mensajeEmail="<span style='background:pink;color:black;font-family:ITC Avant Garde Std, Arial, Helvetica, sans-serif;font-weight: normal;font-size: 12px;'>PERMISO TEMPORAL el Número $NP ( $nombre_comercial_establecimiento ) Folio ( $folio ) Giro ( $GIRO ).</span> <i><u>Para imprimir el Permiso debes de usar el siguiente</i></u> <b>NIP: $NIPgenerado </b>";
