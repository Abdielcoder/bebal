...
$id_cierre_temporal=$_POST['id_proceso_tramites'];
$folio=$_POST['folio'];
...
$sql20="UPDATE pagos SET estatus_pago='PAGADO', numero_pago='$numero_pago', monto='$monto', fecha_pago='$fecha_pago' WHERE id_principal=".$ID." AND id_proceso_tramites=".$id_cierre_temporal." AND concepto='Cierre Temporal'";
...
################
$Kuery_Update_principal="UPDATE principal SET  estatus='Pago Cierre Temporal', nip='$nip'  WHERE id=".$ID;
...
$mensajeEmail="<span style='background:yellow;color:black;font-family:ITC Avant Garde Std, Arial, Helvetica, sans-serif;font-weight: normal;font-size: 12px;'>CIERRE TEMPORAL del Permiso Número $numero_permiso ( $nombre_comercial_establecimiento ) Folio ( $folio ) Giro ( $GIRO ).</span> <b>NIP: $nip </b>";
