...
$nombre_archivo='T-'.$id_registro.'-'.$id_proceso_tramites.'-'.$conjunto.'.pdf';
...
switch ($conjunto) {
  case "c1":
        $query="UPDATE proceso_tramites_temp SET docs_pdf1='$nombre_archivo', estatus_docs_pdf1='OK'  WHERE id=$id_proceso_tramites AND id_principal=".$id_registro;
    break;
  case "c2":
        $query="UPDATE proceso_tramites_temp SET docs_pdf2='$nombre_archivo', estatus_docs_pdf2='OK'  WHERE id=$id_proceso_tramites AND id_principal=".$id_registro;
    break;
  case "c3":
        $query="UPDATE proceso_tramites_temp SET docs_pdf3='$nombre_archivo', estatus_docs_pdf3='OK'  WHERE id=$id_proceso_tramites AND id_principal=".$id_registro;
    break;
  case "c4":
        $query="UPDATE proceso_tramites_temp SET docs_pdf4='$nombre_archivo', estatus_docs_pdf4='OK'  WHERE id=$id_proceso_tramites AND id_principal=".$id_registro;
    break;
}
