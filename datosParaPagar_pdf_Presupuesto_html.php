...
$NOTA=$row_proceso_tramites['nota'];
###########################
$sql_pago="SELECT * FROM pagos WHERE id_principal=".$ID." AND id_proceso_tramites=".$id_proceso_tramites_principal." AND concepto='Tramite Cambio'";
