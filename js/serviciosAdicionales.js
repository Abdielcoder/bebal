                ...
                function load(page){
                        ...
                        $.ajax({
				url:'./ajax/buscar_serviciosAdicionales.php?action=ajax&page='+page+'&q='+q,
...
//		}
	...
	function eliminar (id)
		{
		var q= $("#q").val();
		if (confirm("Realmente deseas eliminar el Servicio Adicional ?")){	
		$.ajax({
        type: "GET",
        url: "./ajax/buscar_serviciosAdicionales.php",
        data: "id="+id,"q":q,
		 beforeSend: function(objeto){
