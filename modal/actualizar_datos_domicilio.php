...
<?php
	...
	?>
	<!-- Modal -->
	<div class="modal fade" id="ActualizarCambioDeDomicilioEstablecimiento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
		  <div class="modal-header"  style="background-color:#FF0000;color:black">
<!--<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>--!>
			<h6 class="modal-title" id="myModalLabel"><i class='bi bi-pencil'></i>Actualizar - Domicilio Establecimiento</h6>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="guardar_registroPrincipalDomicilioEstablecimiento" name="guardar_registroPrincipalDomicilioEstablecimiento">
			<div id="resultados_ajaxActualizarDomicilioEstablecimiento"></div>
...
echo '<div class="col-sm-4">';
echo "<select class='form-control  form-select' name='id_delegacion' id='mod_id_delegacion' onChange='getColonias99(this.value);' required>";
...
echo '<div class="col-sm-4">';
echo "<select class='form-control  form-select' name='mod_id_colonia' id='colonias99-list' required>";
...
<button type="submit" class="btn btn-primary" id="Button_guardar_registroPrincipalDomicilioEstablecimiento"  style="background-color:#FF0000;color:black"> Actualizar Registro </button>
</div>
