...
<?php
	...
	?>
	<!-- Modal -->
	<div class="modal fade" id="ActualizarDatosEstablecimientoTemporal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
		  <div class="modal-header"  style="background-color:#FF0000;color:black">
<!--<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>--!>
			<h6 class="modal-title" id="myModalLabel"><i class='bi bi-pencil'></i>Actualizar Registro Datos Establecimiento - Permiso Temporal</h6>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="guardar_PrincipalEstablecimientoInicioTemporal" name="guardar_PrincipalEstablecimientoInicioTemporal">
			<div id="resultados_ajaxGuardarPrincipalEstablecimientoInicioTemporal"></div>
...
<button type="submit" class="btn btn-primary" id="Button_guardar_PrincipalEstablecimientoInicioTemporal"  style="background-color:#FF0000;color:black"> Guardar Datos </button>
</div>
