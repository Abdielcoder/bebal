...
<?php
	...
	?>
	<!-- Modal -->
	<div class="modal fade" id="ActualizarTitularHerencia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
		  <div class="modal-header"  style="background-color:#FF0000;color:black">
<!--<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>--!>
			<h6 class="modal-title" id="myModalLabel"><i class='bi bi-pencil'></i>Actualizar - Titular por Herencia</h6>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="guardar_registroPrincipalTitularHerencia" name="guardar_registroPrincipalTitularHerencia">
			<div id="resultados_ajaxActualizarDatosTitularHerencia"></div>
...
<button type="submit" class="btn btn-primary" id="Button_guardar_registroPrincipalTitularHerencia"  style="background-color:#FF0000;color:black"> Actualizar Registro </button>
</div>
