...
<div class="alert alert-info">
  <i class="bi bi-info-circle"></i> Asegúrese de que el Contribuyente Conce el Presupuesto para el Trámite.
</div>
...
<button type="submit" class="btn btn-primary" id="Button_aprobrarTramite"> Aprobar Trámite </button>
  </div>
  </form>
 </div>
 </div>
