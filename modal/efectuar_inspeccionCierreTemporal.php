...
<?php
	...
	?>
	<!-- Modal -->
        <div class="modal fade" id="EfectuarInspeccionCierreTemporal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<div class="modal-header"  style="background-color:#AC905B;color:white">
			...
			<h6 class="modal-title" id="EfectuarInspeccionLabel"><i class="bi bi-clipboard-check"></i> Registrar Inspección - Cierre Temporal</h6>
 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> 
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="registro_guardar_inspeccionCierreTemporal" name="registro_guardar_inspeccionCierreTemporal">
			<div id="resultados_ajaxInspeccionCierreTemporal"></div>
...
<input type="hidden" id="mod_id_cierre_temporal" name="id_cierre_temporal">
...
echo '<input type="text" class="form-control required" title="Enter Latitud ( 32.5317387 )"  pattern="(32\.)[\d]{6,}"  id="mod_latitud" name="latitud" maxlength="12" autocomplete="off"   required>';
echo '</div>';
//##
echo '<label for="longitud" class="col-sm-2 col-form-label">Longitud<br><font size="2" color="blue">Ej: -117.019529</font></label>';
echo '<div class="col-sm-4">';
echo '<input type="text" class="form-control required"  title="Enter Longitud (-117.019529)"   pattern="(-)(116|117)(\.)[\d]{6,}" id="mod_longitud" name="longitud" maxlength="12" autocomplete="off"  required>';
echo '</div>';
echo '</div>';
###
?>
...
<button type="submit" class="btn btn-primary" id="Button_registro_guardar_inspeccionCierreTemporal"  style="background-color:#AC905B;color:black"> Registrar Inspección </button>
		  </div>
		  </form>
		</div>
	  </div>
