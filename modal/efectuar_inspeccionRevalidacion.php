...
<?php
	...
	?>
	<!-- Modal -->
        <div class="modal fade" id="EfectuarInspeccionRevalidacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<div class="modal-header"  style="background-color:#AC905B;color:white">
			...
			<h6 class="modal-title" id="EfectuarInspeccionLabel"><i class="bi bi-clipboard-check"></i> Registrar Inspección - Revalidación</h6>
 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> 
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="registro_guardar_inspeccionRevalidacion" name="registro_guardar_inspeccionRevalidacion">
			<div id="resultados_ajaxInspeccionRevalidacion"></div>
...
<button type="submit" class="btn btn-primary" id="Button_registro_guardar_inspeccionRevalidacion"  style="background-color:#AC905B;color:black"> Registrar Inspección </button>
		  </div>
		  </form>
		</div>
	  </div>
