...
<button type="submit" class="btn btn-primary" id="Button_registro_guardar_inspeccionTemp"  style="background-color:#AC905B;color:black"> Registrar Inspección </button>
		  </div>
		  </form>
		</div>
	  </div>
