...
?>
	<!-- Modal -->
	<div class="modal fade" id="imprimirpermisoTemporal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document" >
		<div class="modal-content"  style="background-color:#FF0000;color:white">

                  <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title" id="ImprimirPermisoLabel"><i class="bi bi-p-square"></i> Imprimir Permiso Temporal</h5>

			<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="imprimirPermisoTemporal" name="imprimirPermisoTemporal" action="permisoTemporal_pdf_html.php" target="_blank">
			<div id="resultados_ajaxImprimirPermisoTemporal"></div>
...
<div class="form-group row">
<label for="mod_numero_permiso_imprimir" class="col-sm-3 control-label"><font size="2">Número Permiso Temporal</font></label>
<div class="col-sm-8">
...
<i class="bi bi-exclamation-triangle"></i><font size="2">Esta acción Imprimirá el Permiso Temporal, requieres el NIP.</font></div>

			
</div>
 <div class="modal-footer">
<button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal"><font size="2">Cancelar</font></button>
<button type="submit" class="btn btn-xs btn-danger" id="imprimirPermisoTemporal">
