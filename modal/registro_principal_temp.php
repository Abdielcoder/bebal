...
function procesando_KK2() {
  var element = document.getElementById("Respuesta");
  element.classList.remove("content2_KK2");
  element.classList.toggle("content_KK2");
  element.classList.toggle("blink_KK2");
document.getElementById("Respuesta").innerHTML = "Procesando Consulta Sistema Predial .......";
}

function finalizado_KK2() {
document.getElementById("mensaje").innerHTML = "Finalizado";
}

function getPredial_KK2(forma) {
...
//async : false,
  ...
  var element = document.getElementById("Respuesta");
  element.classList.remove("blink_KK2");
  element.classList.toggle("content2_KK2");
  ...
  elemento.classList.remove("blink_KK2");
  elemento.classList.toggle("content3_KK2");
...
<?php
	...
	?>
	<!-- Modal -->
	<div class="modal fade" id="nuevoRegistroPrincipalTemporal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
		  <div class="modal-header"  style="background-color:#AC905B;color:white">
			<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<h6 class="modal-title" id="myModalLabel"><i class='bi bi-pencil'></i> Agregar Nuevo Registro -  Permiso Temporal</h6>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="guardar_registroPrincipalTemporal" name="guardar_registroPrincipalTemporal">
			<div id="resultados_ajaxGuardarRegistroPrincipalTemporal"></div>
...
##########################
##########################
echo '<h4><span style="background:black"><font color="white" size="3">Datos del Establecimiento - Permiso Temporal</font></span></h4>';
...
echo '<br><a href="javascript:getPredial_KK2(document.guardar_registroPrincipalTemporal)" style="background-color:#000000;color:white"><font size="1">Consultar</font></a>';
echo '</label>';
...
//echo '<br><a href="javascript:getNoCuenta_CC2(document.guardar_registroPrincipalTemporal)" style="background-color:#000000;color:white"><font size="1">Consultar</font></a>';
echo '</label>';
echo '<div class="col-sm-2 form-check">';
//echo '<label class="form-check-label" for="clave_catastral">Dato Número Catastral</label>';
...
##########################
##########################
echo '<h4><span style="background:black"><font color="white" size="3">Datos del Solicitante - Permiso Temporal</font></span></h4>';
##
...
<button type="submit" class="btn btn-primary" id="Button_guardar_registroPrincipalTemporal"  style="background-color:#AC905B;color:black"> Guardar Datos - Permiso Temporal</button>
</div>

</form>
<p><font color="white" size="1">modal/registro_principal_temp.php-(Button_guardar_registroPrincipalTemporal)->ajax/nuevo_registroPrincipalTemporal.php</font></p>
</div>
</div>
</div>
<?php
