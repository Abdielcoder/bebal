...
echo '<br><a href="javascript:getPredial_KK2(document.guardar_registroPrincipalTemporal)" style="background-color:#000000;color:white"><font size="1">Consultar Predial</font></a>';
echo '</label>';
