...
function procesando_PP3() {
  var element = document.getElementById("Respuesta_PP3");
  element.classList.remove("content2_PP3");
  element.classList.toggle("content_PP3");
  element.classList.toggle("blink_PP3");
document.getElementById("Respuesta_PP3").innerHTML = "Procesando Consulta Sistema Tesoreria .......";
}

function finalizado_PP3() {
document.getElementById("mensaje").innerHTML = "Finalizado";
}


function getRecibo_PP3(forma) {
...
timeout: 5000,
  ...
  var Respuesta_PP3=mensaje.nodeValue+" $"+importe.nodeValue+" estatus ("+idstatus.nodeValue+")";

  var element = document.getElementById("Respuesta_PP3");
  element.classList.remove("blink_PP3");
  element.classList.toggle("content2_PP3");

  document.getElementById("Respuesta_PP3").innerHTML = Respuesta_PP3;
  },
error: function(){
  var element = document.getElementById("Respuesta_PP3");
  element.classList.remove("blink_PP3");
  element.classList.toggle("content3_PP3");

  document.getElementById("Respuesta_PP3").innerHTML = 'Fallo Consulta del Recibo de Pago';
...
echo '<a href="javascript:getRecibo_PP3(document.registro_guardar_pago_presupuestoTramite)" style="background-color:#000000;color:white"><font size="1">Consultar Recibo</font></a>';
echo '</div>';
...
echo '<div id="Respuesta_PP3" style="color:black;font-size:12px;"></div>';
echo '</div>';
