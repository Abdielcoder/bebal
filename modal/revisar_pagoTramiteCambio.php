...
function procesando_PP5() {
  var element = document.getElementById("Respuesta_PP5");
  element.classList.remove("content2_PP5");
  element.classList.toggle("content_PP5");
  element.classList.toggle("blink_PP5");
document.getElementById("Respuesta_PP5").innerHTML = "Procesando Consulta Sistema Tesoreria .......";
}

function finalizado_PP5() {
document.getElementById("mensaje").innerHTML = "Finalizado";
}


function getRecibo_PP5(forma) {
...
timeout: 5000,
  ...
  var Respuesta_PP5=mensaje.nodeValue+" $"+importe.nodeValue+" estatus ("+idstatus.nodeValue+")";

  var element = document.getElementById("Respuesta_PP5");
  element.classList.remove("blink_PP5");
  element.classList.toggle("content2_PP5");

  document.getElementById("Respuesta_PP5").innerHTML = Respuesta_PP5;
  },
error: function(){
  var element = document.getElementById("Respuesta_PP5");
  element.classList.remove("blink_PP5");
  element.classList.toggle("content3_PP5");

  document.getElementById("Respuesta_PP5").innerHTML = 'Fallo Consulta del Recibo de Pago';
...
echo '<a href="javascript:getRecibo_PP5(document.registro_guardar_pagoTramiteCambio)" style="background-color:#000000;color:white"><font size="1">Consultar Recibo</font></a>';
echo '</div>';
...
echo '<div id="Respuesta_PP5" style="color:black;font-size:12px;"></div>';
echo '</div>';
