...
include("modal/efectuar_inspeccionRevalidacion.php");
...
################
#chang
$KueryPT_FINALIZADO= "SELECT COUNT(*)  AS cuentaFINALIZADO FROM inspeccion WHERE en_proceso='FIN' AND id_principal=$IDPRINCIPAL AND id_proceso_tramites=0 AND observaciones='En Proceso Revalidacion'";
...
$ret .= '<form ENCTYPE="multipart/form-data" name="subirnuevafoto" action="principalFotosRevalidacion.php" method="POST">';
...
echo '<a href="#" class="btn btn-danger btn-sm" title="Efectuar Inspeccion" onclick="obtener_datosInspeccion('.$IDPRINCIPAL.');" data-bs-toggle="modal" data-bs-target="#EfectuarInspeccionRevalidacion"><i class="bi bi-gear"></i><font size="1"> Registrar Inspección </font></a>';
}
...
$( "#registro_guardar_inspeccionRevalidacion" ).submit(function( event ) {
  $('#Button_registro_guardar_inspeccionRevalidacion').attr("disabled", true);

 var parametros = $(this).serialize();
         $.ajax({
                        type: "POST",
                        url: "ajax/registro_guardar_inspeccionRevalidacion.php",
                        data: parametros,
                         beforeSend: function(objeto){
                                $("#resultados_ajaxInspeccionRevalidacion").html("Mensaje: Cargando...");
                          },
                        success: function(datos){
                        $("#resultados_ajaxInspeccionRevalidacion").html(datos);
                        $('#Button_registro_guardar_inspeccionRevalidacion').attr("disabled", true);
