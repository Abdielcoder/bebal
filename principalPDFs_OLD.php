...
$errorpdf= 'ERROR GENERAL.........';
	...
	$queryUPDATE="UPDATE proceso_tramites SET $column1_Update='$filename', $column2_Update='OK'  WHERE id=$ID_PROCESO_TRAMITES AND id_principal=".$IDPRINCIPAL;
	##echo $queryUPDATE;
...
$errorpdf= 'ERROR GENERAL.........';
	...
	$queryUPDATE="UPDATE proceso_tramites SET $column1_Update='', $column2_Update=''  WHERE id=$ID_PROCESO_TRAMITES AND id_principal=".$IDPRINCIPAL;
	##echo $queryUPDATE;
if (!mysqli_query($con,$queryUPDATE)) echo mysqli_error();
...
$KueryPT_SEPUEDECERRAR="SELECT COUNT(*) AS cuentaSEPUEDECERRAR FROM proceso_tramites WHERE en_proceso='EN PROCESO' AND id_principal=$IDPRINCIPAL AND id_tramite=$ID_TRAMITE AND id=$ID_PROCESO_TRAMITES AND estatus_docs_pdf1='OK' AND estatus_docs_pdf2='OK' AND estatus_docs_pdf3='OK' AND estatus_docs_pdf4='OK'";
...
if  ( $cuentaSEPUEDECERRAR> 0 ) {
	$queryUPDATE="UPDATE  recepcion_analisis_documentos SET en_proceso='FIN', fecha_fin='$today' WHERE id_principal=$IDPRINCIPAL AND id_proceso_tramites=$ID_PROCESO_TRAMITES";
	##echo $queryUPDATE;
...
$Kuery_ChecarEstatus="SELECT COUNT(*) AS CuentaChecarEstatus FROM principal WHERE estatus='Inspeccion Realizada' AND id=".$IDPRINCIPAL;
...
$Kuery_Update2="UPDATE principal SET estatus='RAD Realizado' WHERE id=".$IDPRINCIPAL;
}
...
$domicilio_establecimiento=$calle_establecimiento." #".$numero_establecimientoDB." ".$numerointerno_local_establecimientoDB." CP ".$cp_establecimientoDB.", ".$COLONIA." (".$DELEGACION.") ".$MUNICIPIO;

echo "<h6><b><span style='background:#AC905B;'><font color='white'>Revisón y Análisis de Documentos  :</span></b><font color='black'> Folio (".$folioDB."), ".$nombre_comercial_establecimientoDB." (".$GIRO."), ".$domicilio_establecimiento."</font></h6>";
##############################
if (!isset($errorpdf)) {
	$errorpdf="";
} else {
...
################
################
##$KueryPT="SELECT * FROM proceso_tramites WHERE id_principal=$IDPRINCIPAL AND id_tramite=$id_tramite AND id=$id_proceso_tramites";
$KueryPT="SELECT * FROM proceso_tramites WHERE id_principal=$IDPRINCIPAL AND id_tramite=$id_tramite";
##echo $KueryPT;
...
################
$KueryPT_FINALIZADO= "SELECT COUNT(*)  AS cuentaFINALIZADO FROM recepcion_analisis_documentos WHERE en_proceso='FIN' AND id_principal=$IDPRINCIPAL AND id_proceso_tramites=$id_proceso_tramites";
...
if (empty($docs_pdf1DB) || $docs_pdf1DB=='' ) echo '<img class="item-img img-responsive" src="img/noPDF.jpg" alt="" alt=""  style="width:100px;height:100px;">';
else {
...
echo '<image class="item-img img-responsive" src="img/pdfLogo.jpg" alt="" alt=""  style="width:100px;height:100px;"  data-target="#ModalPDF1" data-toggle="modal"></a>';
...
echo '<form name="eliminarPDF1" action="principalPDFs.php" method="POST">';
...
echo '<form ENCTYPE="multipart/form-data" name="subirnuevoPDF1" action="principalPDFs.php" method="POST">';
?>
<div class="input_container">
<label for="files1" class="btn btn-info btn-sm"><i class="bi bi-file-earmark-pdf"></i><font size="1">PDF 1</font></label>
<input id="files1" name="nuevoPDF1" style="display:none;" type="file">
</div>
<p></p>
<?php
...
#########
echo "<td align=center>";
if ( empty($docs_pdf2DB)  || $docs_pdf2DB=='' ) echo '<img class="item-img img-responsive" src="img/noPDF.jpg" alt="" alt=""  style="width:100px;height:100px;">';
else {
##echo '<img class="item-img img-responsive" src="img/pdfLogo.jpg" alt="" alt=""  style="width:100px;height:100px;">';

echo '<a href="#"   data-bs-toggle="modal" data-bs-target="#ModalPDF2">';
echo '<image class="item-img img-responsive" src="img/pdfLogo.jpg" alt="" alt=""  style="width:100px;height:100px;"  data-target="#ModalPDF2" data-toggle="modal"></a>';
...
echo '<form name="eliminarPDF2" action="principalPDFs.php" method="POST">';
...
<input id="files2" name="nuevoPDF2" style="display:none;" type="file">
</div>
<p></p>
<?php
##echo "<input type='file'   name='nuevoPDF' class='choose'>";
...
echo "<td align=center>";
if ( empty($docs_pdf3DB)  || $docs_pdf3DB=='' ) echo '<img class="item-img img-responsive" src="img/noPDF.jpg" alt="" alt=""  style="width:100px;height:100px;">';
else {
##echo '<img class="item-img img-responsive" src="img/pdfLogo.jpg" alt="" alt=""  style="width:100px;height:100px;">';

echo '<a href="#"   data-bs-toggle="modal" data-bs-target="#ModalPDF3">';
echo '<image class="item-img img-responsive" src="img/pdfLogo.jpg" alt="" alt=""  style="width:100px;height:100px;"  data-target="#ModalPDF3" data-toggle="modal"></a>';
...
echo '<form name="eliminarPDF3" action="principalPDFs.php" method="POST">';
...
<input id="files3" name="nuevoPDF3" style="display:none;" type="file">
</div>
<p></p>
<?php
##echo "<input type='file'   name='nuevoPDF' class='choose'>";
...
echo "<td align=center>";
if ( empty($docs_pdf4DB)  || $docs_pdf4DB=='' ) echo '<img class="item-img img-responsive" src="img/noPDF.jpg" alt="" alt=""  style="width:100px;height:100px;">';
else {
##echo '<img class="item-img img-responsive" src="img/pdfLogo.jpg" alt="" alt=""  style="width:100px;height:100px;">';

echo '<a href="#"   data-bs-toggle="modal" data-bs-target="#ModalPDF4">';
echo '<image class="item-img img-responsive" src="img/pdfLogo.jpg" alt="" alt=""  style="width:100px;height:100px;"  data-target="#ModalPDF4" data-toggle="modal"></a>';
...
echo '<form name="eliminarPDF4" action="principalPDFs.php" method="POST">';
...
<input id="files4" name="nuevoPDF4" style="display:none;" type="file">
</div>
<p></p>
<?php
##echo "<input type='file'   name='nuevoPDF' class='choose'>";
...
echo '</td><td>';
echo '<form name="cerrarTrabajoPDF" action="principalPDFs.php" method="POST">';
